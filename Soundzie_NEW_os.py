...
def Rock_Paper_Scissor():
    ...
    Bg = PhotoImage(file=os.path.join(path,"GUI","images","GAMER_2.png"))
    # CREATING LABEL
    my_label = Label(root, image = Bg)
    my_label.place(x=0, y=0, relwidth=1, relheight=1)

    # Define our images
    rock = PhotoImage(file = os.path.join(path,"GUI","images","ROCK_5.png"))
    paper = PhotoImage(file = os.path.join(path,"GUI","images","PAPER_5.png"))
    scissors = PhotoImage(file = os.path.join(path,"GUI","images","SCISSORS_5.png"))
...
def Select_game():
    ...
    game_selection.iconbitmap(os.path.join(path,"GUI","images","icon_3.ico"))
    
    img1 = Image.open(os.path.join(path,"GUI","images","GAMER_1.png"))
...
def mp3():
    ...
    root.title('Soundzie')
    root.iconbitmap(os.path.join(path,"GUI","images","icon_3.ico"))
    ...
    # BACKGROUND IMAGE
    Bg = PhotoImage(file=os.path.join(path,"GUI","images","music_bg_5.png"))
    ...
    def play_time():
        ...
        song = os.path.join(path,"audio","{}").format(song)
    ...
    # Add Song Function
    def add_song():
        song = filedialog.askopenfilename(initialdir=os.path.join(path,"audio"), title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"),))

        # strip out the directory info and .mp3 extension from the song name
        # song = song.replace(os.path.join(path,"audio"), "")
    ...
    def add_many_songs():
        songs = filedialog.askopenfilenames(initialdir=os.path.join(path,"audio"), title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"),))
    ...
    back_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","BACKWARD.png"))
    forward_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","FORWARD.png"))
    play_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","PLAY.png"))
    pause_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","PAUSE.png"))
    stop_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","STOP.png"))
    vol_increase_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","VOL_UP.png"))
    vol_decrease_btn_img = PhotoImage(file = os.path.join(path,"GUI","images","VOL_DOWN.png"))
...
def mp4():
    ...
    Video1.iconbitmap(os.path.join(path,"GUI","images","icon_3.ico"))

    bg = PhotoImage(file=os.path.join(path,"GUI","images","1.png"))
...
def add_video():
    ...
    video11 = filedialog.askopenfilename(initialdir=os.path.join(path,"GUI","video"), title="Choose A Video", filetypes=(("mp4 Files", "*.mp4"),))
...
Home_Page.resizable(False, False)
Home_Page.iconbitmap(os.path.join(path,"GUI","images","icon_3.ico"))

bg = PhotoImage(file = os.path.join(path,"GUI","images","6.png"))
